...
function auto_suggest_location() {
  ...
  let input_destination = document.getElementById(
    "searchTextField_destination"
  );
  let tourist_destination = document.getElementById("address");

  let autocomplete_input_start = new google.maps.places.Autocomplete(
    input_start,
    options
  );
  let autocomplete_input_destination = new google.maps.places.Autocomplete(
    input_destination,
    options
  );
  let auto_tourism_destination = new google.maps.places.Autocomplete(
    tourist_destination,
    options
  );
  ...
  google.maps.event.addListener(
    ...
    function () {
      ...
      document.getElementById(
        "start_lat"
      ).value = start.geometry.location.lat();
      document.getElementById(
        "start_lng"
      ).value = start.geometry.location.lng();
